<?php include_once __DIR__ . "/../header.php"; ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            <div>
                <form class="form-horizontal" action="/?model=order&action=update" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?= $one['user_id'] ?? '' ?>" name="user_id" readonly
                                       class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?= $one['total'] ?? '' ?>" name="total" readonly
                                       class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?= $one['comment'] ?? '' ?>" readonly name="comment"
                                       class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?= $one['created'] ?? '' ?>" readonly name="created"
                                       class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?= $one['updated'] ?? '' ?>" readonly name="updated"
                                       class="form-control">
                            </div>
                        </div>
                        <div>
